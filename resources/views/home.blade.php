...
<div style="padding-top:80px; background-image: url({{ asset('storage/frontend/home.jpg') }}); height: 60vh; background-attachment: fixed; background-size: cover; background-position:center">
...
<div class="d-flex mt-5 mb-5" style="justify-content: space-evenly">
    <a href="" class="card" style="width: 18rem; text-decoration: none; color: black; border-radius: 10px" onmouseover="cardOver(this)" onmouseout="cardOut(this)">
        <img src="{{ asset('storage/frontend/buyicon.jpg') }}" class="card-img-top" alt="..." style="height: 160px; border-top-left-radius: 10px; border-top-right-radius: 10px">
        <div class="card-body" style="text-align: center">
            <h5 class="card-title">Buy Real Estates</h5>
        </div>
    </a>
    <a href="" class="card" style="width: 18rem; text-decoration: none; color: black; border-radius: 10px" onmouseover="cardOver(this)" onmouseout="cardOut(this)">
        <img src="{{ asset('storage/frontend/renticon.jpg') }}" class="card-img-top" alt="..." style="height: 160px; border-top-left-radius: 10px; border-top-right-radius: 10px">
        <div class="card-body" style="text-align: center">
            <h5 class="card-title">Rent Real Estates</h5>
        </div>
    </a>
    <a href="" class="card" style="width: 18rem; text-decoration: none; color: black; border-radius: 10px" onmouseover="cardOver(this)" onmouseout="cardOut(this)">
        <img src="{{ asset('storage/frontend/abouticon.jpg') }}" class="card-img-top" alt="..." style="height: 160px; border-top-left-radius: 10px; border-top-right-radius: 10px">
        <div class="card-body" style="text-align: center">
